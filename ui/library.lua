--[[
Octohook ui lib rainhook version
...
local library = {
    ...
    images = {
        ['gradientp90'] = 'https://raw.githubusercontent.com/river1337/rainhook/main/ui/assets/gradient90.png';
        ['gradientp45'] = 'https://raw.githubusercontent.com/river1337/rainhook/main/ui/assets/gradient45.png';
        ['colorhue'] = 'https://raw.githubusercontent.com/river1337/rainhook/main/ui/assets/lgbtqshit.png';
        ['colortrans'] = 'https://raw.githubusercontent.com/river1337/rainhook/main/ui/assets/trans.png';
    };
    numberStrings = {['Zero'] = 0, ['One'] = 1, ['Two'] = 2, ['Three'] = 3, ['Four'] = 4, ['Five'] = 5, ['Six'] = 6, ['Seven'] = 7, ['Eight'] = 8, ['Nine'] = 9};
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/river1337/rainhook/main/ui/signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'rainhook.vip';
...
library.themes = {
    {
        name = 'Default',
        theme = {
            ['Accent']              = fromRGB(159, 115, 216);
            ['Background']          = fromRGB(15,15,20);
            ['Border']              = fromRGB(0,0,0);
            ['Border 1']            = fromRGB(10,10,15);
            ['Border 2']            = fromRGB(45,45,50);
            ['Border 3']            = fromRGB(35,35,40);
            ['Primary Text']        = fromRGB(240,240,240);
            ['Secondary Text']      = fromRGB(145, 145, 145);
            ['Group Background']    = fromRGB(20,20,25);
            ['Selected Tab']        = fromRGB(20,20,25);
            ['Unselected Tab']      = fromRGB(23,23,28);
            ['Selected Tab Text']   = fromRGB(240,240,240);
            ['Unselected Tab Text'] = fromRGB(145,145,145);
            ['Section Background']  = fromRGB(18,18,23);
            ['Option Text 1']       = fromRGB(235,235,235);
            ['Option Text 2']       = fromRGB(155,155,155);
            ['Option Border 1']     = fromRGB(45,45,50);
            ['Option Border 2']     = fromRGB(0,0,0);
            ['Option Background']   = fromRGB(31,31,34);
    ...
    },
    {
        name = 'Bbot',
        theme = {
            ['Accent'] =                     fromRGB(181, 145, 245);
            ['Background'] =                 fromRGB(24, 22, 31);
            ['Border'] =                     fromRGB(0, 0, 0);
            ['Border 1'] =                   fromRGB(50, 50, 50);
            ['Border 2'] =                   fromRGB(30, 25, 38);
            ['Border 3'] =                   fromRGB(10, 10, 10);
            ['Primary Text'] =               fromRGB(235, 235, 235);
            ['Group Background'] =           fromRGB(30, 25, 38);
            ['Selected Tab Background'] =    fromRGB(30, 25, 38);
            ['Unselected Tab Background'] =  fromRGB(25, 22, 31);
            ['Selected Tab Text'] =          fromRGB(245, 245, 245);
            ['Unselected Tab Text'] =        fromRGB(145, 145, 145);
            ['Section Background'] =         fromRGB(25, 22, 31);
            ...
            ['Option Border 2'] =            fromRGB(0, 0, 0);
            ['Option Background'] =          fromRGB(30, 25, 38);
            ["Risky Text"] =                 fromRGB(175, 21, 21);
            ["Risky Text Enabled"] =         fromRGB(255, 41, 41);
        }
    },
...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "river (face.shxt)"})
    creditsSection:AddSeparator({text = 'Helpers'});
    creditsSection:AddText({text = "creida is god"})
